...
//--local defines--
#define MSP_PROJECT_LOGO_LEN  512
#define WIFI1_ICON_LEN        32
#define MOBILE_ICON_LEN       32
#define BLANK_ICON_LEN        32
#define NOCON_ICON_LEN        32
#define SD_ICON_LEN           32
#define CLOCK_ICON_LEN        32


typedef struct __ICONS__ {
  unsigned char msp_icon64x64[MSP_PROJECT_LOGO_LEN];
  unsigned char wifi1_icon16x16[WIFI1_ICON_LEN];
  unsigned char mobile_icon16x16[MOBILE_ICON_LEN];
  unsigned char blank_icon16x16[BLANK_ICON_LEN];
  unsigned char nocon_icon16x16[NOCON_ICON_LEN];
  unsigned char sd_icon16x16[SD_ICON_LEN];
  unsigned char clock_icon16x16[CLOCK_ICON_LEN];
}icons_t;
